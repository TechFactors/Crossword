...
public struct UIElements
{
    ...
    [SerializeField] RectTransform correctOrWrong;
    public RectTransform CorrectOrWrong { get { return correctOrWrong; } }

    [SerializeField] RectTransform nextButton;
    public RectTransform NextButton { get { return nextButton; } }

    [SerializeField] RectTransform submitButton;
    public RectTransform SubmitButton { get { return submitButton; } }
}
public class UIManager : MonoBehaviour {

    #region Variables

    public enum         ResolutionScreenType   { Correct, Incorrect, Finish, onReview, onSubmit }
    ...
    void DisplayResolution(ResolutionScreenType type, int score)
    {
        ...
        if (type != ResolutionScreenType.onSubmit)
        { 
    ...
    void UpdateResUI(ResolutionScreenType type, int score)
    {
        ...
        switch (type)
        {
            ...
            case ResolutionScreenType.Incorrect:
                ...
                uIElements.ResolutionScoreText.text = "-" + score;
                break;
            case ResolutionScreenType.onSubmit:
                bool isActive = uIElements.SubmitButton.gameObject.activeSelf ? false : true;
                uIElements.SubmitButton.gameObject.SetActive(isActive);
                break;
            case ResolutionScreenType.Finish:
                StartCoroutine(CalculateScore());
                uIElements.FinishUIElements.gameObject.SetActive(true);
                break;
            case ResolutionScreenType.onReview:
                uIElements.FinishUIElements.gameObject.SetActive(false);
                uIElements.CorrectOrWrong.gameObject.SetActive(true);
                break;
        }
    }
    /// <summary>
    ...
    IEnumerator CalculateScore()
    {
        ...
        while (scoreMoreThanZero ? scoreValue < events.CurrentFinalScore : scoreValue > events.CurrentFinalScore)
        {
            ...
            uIElements.ResolutionScoreText.text = scoreValue.ToString() + "/" + events.answeredQuestions.Count;
